...
//	strcpy(th_direct[t].r_table, routing_table);
	printf("Calling threads to receive route update from neighbor:%ld", ntohl(cliaddr.sin_addr.s_addr), ntohs(cliaddr.sin_port));	
 ...
 void * route_recv (struct sockaddr_in cliaddr)
  {	
	printf("\n\n\n\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Inside thread route_recv~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n\n\n\n\n");
  	pthread_t tid_timer;
	int  length, max_fd, rv, cli_port, s;
	long node_ip;
	struct m_out m_recv;
...
//			printf("\n\n\n\nBefore recv\n\n\n\n\n"); 
			...
			printf("Thread receiving from NEIGHBOR:", n_v_ip);
